	...
	<tr>
		<td align="center" bgcolor="#0767b1">
			<table align="center" width="90%">
				...
				<tr>
					<td align="center">
						<p style="font-family: 'Nunito', sans-serif; font-size: 20px; color: #fff; font-weight: 500; line-height: 32px; letter-spacing: 1px"><em>Use o código abaixo para criar uma<br>nova senha e garanta seu acesso<br>à plataforma Haribo Corrida de Ouro:</em></p>
					</td>
				</tr>
				<tr>
					<td align="center">
