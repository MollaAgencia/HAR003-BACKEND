...
export class CreateUserBodyDto extends PickType(UserDto, ['email', 'name', 'telephone', 'role', 'document']) {
  @ApiProperty({
...
export const SwaggerCreateUserDto = () => {
  return function (target: any, key: any, descriptor: any) {
    ApiResponse({ status: 200, description: 'User successfully registered', type: CreateUserResponseDto })(
      target,
      key,
      descriptor,
    )
